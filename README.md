...
**Hello Rails Back End** is a api application that displays a random greeting from a rails API endpoint.
...
- [Frontend](https://github.com/boo-shehab/hello-react-front-end)
...
```sh
  git clone https://github.com/boo-shehab/hello-rails-back-end.git
```
